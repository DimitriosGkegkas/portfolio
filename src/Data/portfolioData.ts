...
export interface Branch {
  name: string;
  description: string;
  projectIds: string[];  // Reference projects by ID instead of duplicating them
}
...
${COLOR.cyan}$ git checkout education${COLOR.reset}  `,
    ...
    "~/portfolio/web-development/": [
      ...
      },
      {
        ...
        isDir: false,
        created: "May 1 2023",
        content: "# 🏛️ Rotunda Digital Installation\nInteractive E-table for the Rotunda of Thessaloniki.\n\n- Stack: Touchscreen UI, Custom CMS, Cultural Mapping\n- Tags: Cultural Heritage, Physical Installation, Interactive Exhibit\n- Role: Designer & Developer",
      },
      {
        name: "thessalonikiMap.md",
        isDir: false,
        created: "Jun 1 2023",
        content: "# 🏛️ Prewar Thessaloniki 3D Map\nInteractive 3D Historical Map of Jewish Neighborhoods.\n\n- Stack: React Three Fiber, Three.js, Custom Shaders, Draco Compression\n- Tags: Cultural Heritage, 3D Visualization, Historical Preservation\n- Role: Full-stack Developer",
      },
      {
    ...
    "~/portfolio/robotics-ai/": [
      {
        ...
        isDir: false,
        created: "Aug 1 2024",
        content: "# 🚗 Decentralized Multi-Agent RL with Communication\nMaster Thesis - Autonomous Driving Research.\n\n- Stack: ROS2, SUMO, PyTorch, Multi-Agent RL, Simulation\n- Tags: Autonomous Driving, Multi-Agent RL, V2X Communication\n- Role: Researcher\n- Highlights: Safe decision-making in multi-robot systems",
      },
      {
        name: "multiDroneSLAM.md",
        isDir: false,
        created: "Sep 1 2023",
        content: "# 🚁 Multi-Drone Collaborative SLAM\nReal-time Mapping with Kimera-Multi.\n\n- Stack: ROS2, Python, C++, AirSim, Unreal Engine\n- Tags: SLAM, Multi-Agent, Robotics\n- Role: Robotics Engineer\n- Highlights: Sensor fusion and distributed autonomy",
      },
      {
        name: "ganMetrics.md",
        isDir: false,
        created: "Oct 1 2022",
        content: "# 🧠 GAN Metrics for Image Quality Evaluation\nInteractive Framework for AI Model Validation.\n\n- Stack: Python, TensorFlow, PyTorch, Computer Vision\n- Tags: AI, Computer Vision, GAN\n- Role: ML Researcher\n- Highlights: User feedback integration in AI systems",
      },
      {
        name: "roboticArm.md",
        isDir: false,
        created: "Nov 1 2022",
        content: "# 🦾 Robotic Arm Pick & Place\nHackathon Project - 2nd Place.\n\n- Stack: ROS, Python, Computer Vision, Robotics\n- Tags: Robotics, Computer Vision, Manipulation\n- Role: Team Lead\n- Highlights: Real-time vision-based manipulation",
      },
    ],
  },
...
export const getBranchProjects = (branchName: string) => {
  ...
  if (!branch) return [];
  return branch.projectIds.map(id => portfolioData.projects[id]).filter(Boolean);
};
